...
# Caches matching Flask's macro.py implementation
_MACRO_CACHE = {}
...
class MacroDataView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            markets = self._fetch_market_overview()
    ...
    def _fetch_market_overview(self):
        tickers = {
            "S&P 500": "^GSPC",
            "Nasdaq 100": "^IXIC",
            "VIX Fear Index": "^VIX",
...
class MacroHeatmapView(APIView):
    permission_classes = [IsAuthenticated]
    authentication_classes = [SessionAuthentication]
    ...
    def _fetch_heatmap_data(self):
        ...
        for name, sym in indexes.items():
            try:
                ...
                # Fetch YTD using 2026 check (mock current year from context timestamps)
...
class MacroTickerInsightsView(APIView):
    permission_classes = [IsAuthenticated]
    authentication_classes = [SessionAuthentication]
