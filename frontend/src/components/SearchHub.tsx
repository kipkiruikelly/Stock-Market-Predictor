...
const INDEX_ITEMS: SearchItem[] = [
  ...
  { title: 'Enterprise Operations Settings Control Center & Policy Manager', category: 'Operations', route: '/operations/settingscontrol', icon: <Compass size={16} className="text-nexus-pur" /> },
