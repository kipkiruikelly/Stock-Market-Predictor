      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 z-10">
        ...
        <div className="bg-nexus-sf border border-white/5 rounded-[24px] p-8 md:p-10 w-full max-w-[420px] shadow-2xl">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 my-3 text-xs text-gray-400">
              <div className="flex-1 h-[1px] bg-white/10" />
              <span className="uppercase tracking-wider font-semibold text-[10px] text-gray-400">or continue with</span>
              <div className="flex-1 h-[1px] bg-white/10" />
            </div>

            <a
              href="/auth/google"
              className="w-full py-3.5 px-4 bg-white hover:bg-slate-100 text-slate-900 font-bold text-sm rounded-xl shadow-md transition duration-200 flex items-center justify-center gap-3 cursor-pointer border border-white/20 hover:shadow-lg focus:ring-2 focus:ring-purple-500/50"
            ...
            >
              ...
              <span style={{ color: '#0f172a', fontWeight: 700 }}>Sign in with Google</span>
            </a>
          </form>
